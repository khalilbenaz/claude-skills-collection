...
1. **Pas d'écran pendant les repas** (table = moment de famille)
2. **Les écrans s'éteignent 1 h avant le coucher** (mélatonine et sommeil)
3. **Pas d'écran dans la chambre la nuit** (les appareils chargent dans le salon)
4. **Les devoirs et les tâches ménagères d'abord**
5. **Le parent peut vérifier le contenu à tout moment, sans justification**
