...
**Ce qui s'est passé**
Résumé factuel, 2-4 phrases maximum.

**Ce que j'ai pensé**
Liste de pensées, une par ligne. Formulation directe.
...
**Dans mon corps**
Sensations physiques notées.

**Ce que j'ai fait**
Actions posées ou comportements d'évitement.

**Ce que j'aimerais mieux comprendre**
Questions que la personne se pose, formulées à la première personne.
