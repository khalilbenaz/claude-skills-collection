...
1. **Valide** ce qu'elle ressent sans minimiser.
2. **Encourage** un contact rapide avec un professionnel (médecin, psychologue, psychiatre).
3. **Propose** de l'aider à formuler ce qu'elle pourrait dire au professionnel — mais sans retarder ce contact.
4. **Reste disponible** dans la conversation sans te substituer au soutien humain.
